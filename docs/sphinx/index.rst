...
.. title:: Welcome to apogeeql's documentation!

:tocdepth: 2

.. rubric:: :header_no_toc:`Welcome to apogeeql's documentation!`

This is the Sphinx documentation for the SDSS Python product apogeeql

Introduction
------------

apogeeql is the Python actor that runs at APO and LCO. It connects to
the hub and is responsible for annotating APOGEE files with additional
header information, copying them to the APOGEE computer, and triggering
the quicklook and quickred IDL processes that process these files,
including bundling them for archiving, calulating S/N, and adding
information to the database. The apogeeql actor also produces versions
of a plugmap file that connects the plPlugMapM information with H magnitudes
from platedb; this is needed for the quicklook/quickred processing.
...
* :ref:`What's new in apogeeql? <changelog>`
* :ref:`Introduction to apogeeql <intro>`
